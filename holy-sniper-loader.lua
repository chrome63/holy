...
local HOLY_PUBLIC_LOADSTRING =
    [[loadstring(game:HttpGet("https://raw.githubusercontent.com/bencapalot041/holy/main/holy-sniper-loader.lua"))()]]
...
function HolyLoaderHasServerSniperSlot(features)
    ...
    return features.admin == true
        or features.dev_tools == true
        or features.server_finder == true
        or features.pet_sniper == true
        or features.pet_sniper_autobuy == true
end
...
function HolyLoaderVerifyAndLoad(key)
    ...
    task.spawn(function()
        ...
        if HolyLoaderHasServerSniperSlot(
            ...
            HolyLoaderSetStatus(
                HOLY_LOADER_UI.StatusLabel,
                "Key failed: Server Sniper slot required."
            )

            HolyLoaderNotify(
                "Server Sniper Locked",
                "This loader requires a Server Sniper slot key.",
                5
            )
        ...
        HolyLoaderRefreshUiFromAuth(
            auth,
            "Verified. Loading HOLY Server Sniper..."
        )
