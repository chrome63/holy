...
function GAG2FarmDetailsCreateRow(parent, text, muted)
...
function GAG2FarmDetailsCreatePanel()
    ...
    plantedHeader.Position =
        UDim2.new(
            ...
            0,
            0,
            (tonumber(state.SummaryHeight) or 76) + 3
        )
    ...
    toggleButton.Position =
        UDim2.new(
            ...
            0,
            0,
            (tonumber(state.SummaryHeight) or 76) + 2
        )
    ...
    scroll.Position =
        UDim2.new(
            ...
            0,
            0,
            (tonumber(state.SummaryHeight) or 76) + 24
        )
    ...
    GAG2_FARM_DETAILS_PANEL =
        HomeFarmDetailsBox:AddUIPassthrough(
            "HolyGAG2FarmDetailsPanel",
            {
                ...
                Height =
                    tonumber(GAG2_FARM_DETAILS_STATE.PanelHeight)
                    or 214,
